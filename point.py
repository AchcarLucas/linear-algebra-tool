...
class C_Point:
	def __init__(self, x=0, y=0, z=0, color=(0, 0, 0), name='none', visible=False, scale=4.0, has_text=False, text=None):	
		...
		# Ponto original sem transformaÃ§Ã£o
		...
		# Se uma linha ou um vetor estiver utilizando o ponto, o mesmo nÃ£o serÃ¡ exibido na tela
		self.has_used = False
	...
	def render(self, c_draw):
		...
		if self.visible:
			...
			# SÃ³ exibe a posiÃ§Ã£o atual do ponto se nÃ£o estiver sendo usado
